...
<body>
    <div class="menu">
        ...
        <button type="button" class="hide-btn">Hide content info</button> 
    <button type="button" class="show-btn">Show content info</button>
    <p class="very-fast">This webpag will contain.......</p>
    <p class="normal">1.Weather app.</p>
    <p class="fast">2.Weather report.</p>
    <p class="slow">3.Functions.</p>
    <p class="very-slow">4.Sports.</p>
