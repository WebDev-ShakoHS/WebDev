            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="Booking.php" class="btn btn-success pull-right">Add New Reservation</a>
                    </div>
                    <?php
                    // Include config file
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='Cancel.php? id=" . $row['id'] . "' title='Delete Record'>Cancel</a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
