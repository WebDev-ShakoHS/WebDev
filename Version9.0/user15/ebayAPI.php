...
$query = 'New York';  // You may want to supply your own query
...
<head>
    ...
    <link rel='icon' href='Manhattan%20map.jpg' type='image/x-icon'/>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="#" class="nav-item nav-link" tabindex="-1">Manhattan</a>
                    ...
                    <a href="ebayAPI.php" class="nav-item nav-link active" tabindex="-1">New York Souvenirs</a>
            </div>
        </nav>
    </div>
