...
<menu>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="GTAV.php" class="nav-item nav-link active">GTAV</a>
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <img class="animated slideInLeft slow" src="https://www.nme.com/wp-content/uploads/2021/01/gta-v-credit-rockstar-games-2@2000x1270.jpg"></img>
                </div>
                <div class="col-sm-6">
                    <p class="animated slideInRight slow">This game came out 7 years ago and it stretches across 3
                        generations of consoles.</p>
                </div>
            </div>
    </main>
</body>
