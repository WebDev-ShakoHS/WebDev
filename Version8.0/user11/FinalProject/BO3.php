...
<menu>
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-9">
                    <img src="https://i.ytimg.com/vi/ShyhN_je7jU/maxresdefault.jpg" onload="loadImage()"></img>
                </div>
                <div class="col-sm-3">
                    <p class="animated rollIn slow">Black Ops 3 Zombies is very scary if you are playing alone. With friends, it turns into a fun
                        game (but still a bit scary).</p>
                </div>
            </div>
        </div>
    </main>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>I Hope it wasn't too Scary.</p>
            </div>
        </div>
        <div class="row">
            <div class="col">
