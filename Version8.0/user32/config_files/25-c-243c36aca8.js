...
const i=new URL(e)
const s=new URL(t)
return i.origin===s.origin}var T,S,A=function(e,t){return function(){return e.apply(t,arguments)}},z=function(e,t){for(var i in t)w.call(t,i)&&(e[i]=t[i])
...
t["a"]=function(e){z(t,e)
function t(){this.quizzesRespondusEnabled=A(this.quizzesRespondusEnabled,this)
this.showGradersAnonymousToGradersCheckbox=A(this.showGradersAnonymousToGradersCheckbox,this)
this.pollUntilFinished=A(this.pollUntilFinished,this)
this.pollUntilFinishedLoading=A(this.pollUntilFinishedLoading,this)
this.pollUntilFinishedMigrating=A(this.pollUntilFinishedMigrating,this)
this.pollUntilFinishedImporting=A(this.pollUntilFinishedImporting,this)
this.pollUntilFinishedDuplicating=A(this.pollUntilFinishedDuplicating,this)
this.retry_migration=A(this.retry_migration,this)
this.duplicate_failed=A(this.duplicate_failed,this)
this.duplicate=A(this.duplicate,this)
this.setNullDates=A(this.setNullDates,this)
this._filterFrozenAttributes=A(this._filterFrozenAttributes,this)
this._getAssignmentType=A(this._getAssignmentType,this)
this._hasOnlyType=A(this._hasOnlyType,this)
this._submissionTypes=A(this._submissionTypes,this)
this.toView=A(this.toView,this)
this.submissionTypesFrozen=A(this.submissionTypesFrozen,this)
this.failedToImport=A(this.failedToImport,this)
this.isImporting=A(this.isImporting,this)
this.isQuizLTIAssignment=A(this.isQuizLTIAssignment,this)
this.is_quiz_assignment=A(this.is_quiz_assignment,this)
this.originalAssignmentName=A(this.originalAssignmentName,this)
this.originalAssignmentID=A(this.originalAssignmentID,this)
this.originalQuizID=A(this.originalQuizID,this)
this.originalCourseID=A(this.originalCourseID,this)
this.failedToMigrate=A(this.failedToMigrate,this)
this.failedToDuplicate=A(this.failedToDuplicate,this)
this.isMigrating=A(this.isMigrating,this)
this.isDuplicating=A(this.isDuplicating,this)
this.canDuplicate=A(this.canDuplicate,this)
this.singleSectionDueDate=A(this.singleSectionDueDate,this)
this.allDates=A(this.allDates,this)
this.nonBaseDates=A(this.nonBaseDates,this)
this.hasPointsPossible=A(this.hasPointsPossible,this)
this.hasDueDate=A(this.hasDueDate,this)
this.multipleDueDates=A(this.multipleDueDates,this)
this.defaultDates=A(this.defaultDates,this)
this.dueDateRequiredForAccount=A(this.dueDateRequiredForAccount,this)
this.maxNameLengthRequiredForAccount=A(this.maxNameLengthRequiredForAccount,this)
this.maxNameLength=A(this.maxNameLength,this)
this.sisIntegrationSettingsEnabled=A(this.sisIntegrationSettingsEnabled,this)
this.postToSISName=A(this.postToSISName,this)
this.postToSISEnabled=A(this.postToSISEnabled,this)
this.labelId=A(this.labelId,this)
this.htmlEditUrl=A(this.htmlEditUrl,this)
this.htmlUrl=A(this.htmlUrl,this)
this.objectType=A(this.objectType,this)
this.iconType=A(this.iconType,this)
this.useNewQuizIcon=A(this.useNewQuizIcon,this)
this.published=A(this.published,this)
this.isGpaScaled=A(this.isGpaScaled,this)
this.isLetterGraded=A(this.isLetterGraded,this)
this.isSimple=A(this.isSimple,this)
this.externalToolNewTab=A(this.externalToolNewTab,this)
this.externalToolUrl=A(this.externalToolUrl,this)
this.gradingStandardId=A(this.gradingStandardId,this)
this.groupCategoryId=A(this.groupCategoryId,this)
this.vericiteEnabled=A(this.vericiteEnabled,this)
this.turnitinEnabled=A(this.turnitinEnabled,this)
this.gradeGroupStudentsIndividually=A(this.gradeGroupStudentsIndividually,this)
this.vericiteAvailable=A(this.vericiteAvailable,this)
this.turnitinAvailable=A(this.turnitinAvailable,this)
this.allowedExtensions=A(this.allowedExtensions,this)
this.restrictFileExtensions=A(this.restrictFileExtensions,this)
this.notifyOfUpdate=A(this.notifyOfUpdate,this)
this.peerReviewsAssignAt=A(this.peerReviewsAssignAt,this)
this.peerReviewCount=A(this.peerReviewCount,this)
this.automaticPeerReviews=A(this.automaticPeerReviews,this)
this.anonymousPeerReviews=A(this.anonymousPeerReviews,this)
this.peerReviews=A(this.peerReviews,this)
this.graderCommentsVisibleToGraders=A(this.graderCommentsVisibleToGraders,this)
this.gradersAnonymousToGraders=A(this.gradersAnonymousToGraders,this)
this.anonymousGrading=A(this.anonymousGrading,this)
this.anonymousInstructorAnnotations=A(this.anonymousInstructorAnnotations,this)
this.moderatedGrading=A(this.moderatedGrading,this)
this.postToSIS=A(this.postToSIS,this)
this.isOnlineSubmission=A(this.isOnlineSubmission,this)
this.acceptsOnlineTextEntries=A(this.acceptsOnlineTextEntries,this)
this.acceptsMediaRecording=A(this.acceptsMediaRecording,this)
this.acceptsOnlineURL=A(this.acceptsOnlineURL,this)
this.acceptsOnlineUpload=A(this.acceptsOnlineUpload,this)
this.withoutGradedSubmission=A(this.withoutGradedSubmission,this)
this.hasSubmittedSubmissions=A(this.hasSubmittedSubmissions,this)
this.allowedToSubmit=A(this.allowedToSubmit,this)
this.expectsSubmission=A(this.expectsSubmission,this)
this.submissionType=A(this.submissionType,this)
this.isNonDefaultExternalTool=A(this.isNonDefaultExternalTool,this)
this.defaultToolSelected=A(this.defaultToolSelected,this)
this.isQuickCreateDefaultTool=A(this.isQuickCreateDefaultTool,this)
this.defaultToOnPaper=A(this.defaultToOnPaper,this)
this.defaultToOnline=A(this.defaultToOnline,this)
this.defaultToNone=A(this.defaultToNone,this)
this.isDefaultTool=A(this.isDefaultTool,this)
this.shouldShowDefaultTool=A(this.shouldShowDefaultTool,this)
this.isNewAssignment=A(this.isNewAssignment,this)
this.submissionTypes=A(this.submissionTypes,this)
this.courseID=A(this.courseID,this)
this.omitFromFinalGrade=A(this.omitFromFinalGrade,this)
this.gradingType=A(this.gradingType,this)
this.inClosedGradingPeriod=A(this.inClosedGradingPeriod,this)
this.frozenAttributes=A(this.frozenAttributes,this)
this.frozen=A(this.frozen,this)
this.freezeOnCopy=A(this.freezeOnCopy,this)
this.canMove=A(this.canMove,this)
this.canDelete=A(this.canDelete,this)
this.canFreeze=A(this.canFreeze,this)
this.assignmentGroupId=A(this.assignmentGroupId,this)
this.secureParams=A(this.secureParams,this)
this.pointsPossible=A(this.pointsPossible,this)
this.name=A(this.name,this)
this.description=A(this.description,this)
this.dueDateRequired=A(this.dueDateRequired,this)
this.lockAt=A(this.lockAt,this)
this.unlockAt=A(this.unlockAt,this)
this.dueAt=A(this.dueAt,this)
this.assignmentType=A(this.assignmentType,this)
this.isAssignment=A(this.isAssignment,this)
this.isNotGraded=A(this.isNotGraded,this)
this.defaultToolUrl=A(this.defaultToolUrl,this)
this.defaultToolName=A(this.defaultToolName,this)
this.isExternalTool=A(this.isExternalTool,this)
this.isPage=A(this.isPage,this)
this.isDiscussionTopic=A(this.isDiscussionTopic,this)
this.isQuiz=A(this.isQuiz,this)
...
return"Assignment"}
t.prototype.objectTypeDisplayName=function(){if(this.isQuiz()||this.isQuizLTIAssignment())return g.t("Quiz")
...
//# sourceMappingURL=25-c-243c36aca8.js.map