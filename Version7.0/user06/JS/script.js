...
function changeText() {
  document.getElementById("textChange").innerHTML = "Congratulations! You've found our secret cupon code! Email undergrowndmen.10@gmail.com to speak to a lawyer today!";
}
