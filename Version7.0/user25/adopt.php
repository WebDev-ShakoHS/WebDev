...
<head>
  <script src="JS/script.js">
    function myFunction() {
      document.getElementById("demo").innerHTML = "You heard my message!";
    }</script>
  <!--Footer-->
  ...
  <h1 class="custom">
    <left>Great Lord of the Underworld's Pet Adaption</left>
  </h1 class="custom">
  <h2><span class="fire">How </span><span class="burn">to </span><span class="burn">Adopt</span><span
      class="fire"></span></h2>
  ...
  <head>
    ...
    <style>
      body {
        background-image: url("file:///Users/224258/Downloads/4214590572.jpeg");
      }
    </style>
...
<body>
  ...
  <ul class="navbar">
    ...
    <li><a href="demons.html">Our Demon Spawn</a></li>
    <li><a class="active" href="adopt.html">Adopting Process</a></li>
  </ul>
  <h3>
    Adoption Steps
  </h3>
        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-6 px-4">
              <h6> About Company</h6>
              <p>We're selling pets, but from heck!</p>
            ...
            <div class="col-md-6 px-4">
              ...
              <div class="row ">
                ...
                <div class="col-md-6 px-4">
                  <ul>
                    <li> <a href="#"> Shhh</a> </li>
                    <li> <a href="#"> He can hear me</a> </li>
                    <li> <a href="#"> He forced me here</a> </li>
                    <li> <a href="#"> I can't be here</a> </li>
