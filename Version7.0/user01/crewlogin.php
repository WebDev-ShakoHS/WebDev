...
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
    header("location: crewwelcome.php");
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id, username, password FROM crewmates WHERE username = ?";
...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="navbar-nav ml-auto">
                            ...
                            <?php if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
                                ...
                                echo "<a href='crewlogin.php' class='nav-item nav-link active'> Join the Crew </a>";
                            } ?>
                        </div>
                    </div>
                </nav>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="crewregister.php">Sign up now</a>.</p>
        </form>
    </div>
