...
<body>
            ...
            <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <a class="navbar-brand" href="index.html">
                        <img src="images/57px_Logo.png"> Mugiwara
                    </a>
    ...
    <main>
        <div class="content" id="size">
            <div class="images">
                <img src="images/placeholder-image.png" class="auto-slideshow">
                <img src="images/placeholderimage2.jpeg" class="auto-slideshow">
                <img src="images/placeholder-image.png" class="auto-slideshow">
                <img src="images/placeholderimage2.jpeg" class="auto-slideshow">
                <img src="images/placeholder-image.png" class="auto-slideshow">
            </div>
        ...
        <a href="tokyoPlans.php" class="regText">
            <div class="card" style="margin-left: 25px;">
                <img src="images/placeholder-image.png" alt="Tokyo" style="width:100%;">
                <div class="nameplate">
                    <h4><b>Tokyo</b></h4>
        ...
        <a href="chicagoPlans.php" class="regText" class="wow fadeInUp">
            <div class="card">
                <img src="images/placeholder-image.png" alt="France" style="width:100%;">
                <div class="nameplate">
                    <h4><b>Chicago</b></h4>
        ...
        <a href="newyorkPlans.php" class="regText">
            <div class="card">
                <img src="images/placeholder-image.png" alt="Italy" style="width:100%;">
                <div class="nameplate">
                    <h4><b>New York</b></h4>
                </div>
            </div>
