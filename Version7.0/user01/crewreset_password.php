...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="summerIdeas.html">Summer Goals<span class="sr-only">(current)</span></a>
                            </li>
    ...
    <section>
        <h2>View Account</h2>
        <a href="viewaccount.php" class="btn btn-danger" role="button">View Account</a>
    </section>
